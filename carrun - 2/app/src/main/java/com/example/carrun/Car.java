...
public class Car {
    ...
    public Car(){
        ...
        float colortrunk[] = {
                1.0f, 0.0f, 0.0f, 0.0f, 		// v4
                1.0f, 0.0f, 0.0f, 0.0f, 		// v5
                1.0f, 0.0f, 0.0f, 0.0f,			// v0
                1.0f, 0.0f, 0.0f, 0.0f};		// v1
        ...
        float geometryTop[] = {
                ...
                1.0f, 2.0f, 1.0f }; 			// v1
        float colorTop[] = {
                0.9f, 0.0f, 0.0f, 0.0f, 		// v4
                0.9f, 0.0f, 0.0f, 0.0f, 		// v5
                0.9f, 0.0f, 0.0f, 0.0f,			// v0
                0.9f, 0.0f, 0.0f, 0.0f};		// v1
        short topologyTop[] = {0,1,2, 	// v0, v1, v4
               2,1,3};						// v1, v5, v4
        ...
        float colorBacklightLA[] = {
                ...
                1.0f, 1.f, 0.0f, 0.0f,
                1.0f, 1.f, 0.0f, 0.0f};
        short topologyBacklightLA[] = {0,2,1,
                1,2,3};
        ...
        float colorBacklightLB[] = {
                ...
                1.0f, 0.f, 0.0f, 0.0f,
                1.0f, 0.f, 0.0f, 0.0f};
        short topologyBacklightLB[] = {0,2,1,
                1,2,3};
        ...
        float colorBacklightRA[] = {
                ...
                1.0f, 1.f, 0.0f, 0.0f,
                1.0f, 1.f, 0.0f, 0.0f};
        short topologyBacklightRA[] = {0,1,2,
                1,3,2};
        ...
        float colorBacklightRB[] = {
                ...
                1.0f, 0.f, 0.0f, 0.0f,
                1.0f, 0.f, 0.0f, 0.0f};
        short topologyBacklightRB[] = {0,1,2,
                1,3,2};
    ...
    public void updatePosition(){
        ...
        Matrix.translateM(transformationMatrix, 0, xCoord,
                yCoord,
                zCoord);
        if(crashed&&xCoord<50.0f) {
            angle+=10;
            Matrix.rotateM(transformationMatrix, 0, angle, -1.0f,
                    1.0f,
                    0.0f);
            xCoord+=0.5;
            zCoord+=-0.8f;
    ...
    public void changeLane(Lane lane){
        if(lane.xCoord >= xCoord){
            while(!(xCoord >= lane.xCoord)){
                xCoord+= 0.000001f;
                }
        }else{
            while(!(xCoord <= lane.xCoord)){
